...
public class BattleListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        res.findViewById(R.id.battleListItemViewBtn).setOnClickListener(v -> {
            State.INSTANCE.setChosenBattle(battle);
        ...
        res.findViewById(R.id.battleListItemViewOnMapBtn).setOnClickListener(v -> {
            MapActivity.Companion.setViewPoint(battle.getLocation());
            MapActivity.Companion.setViewZoom(MapActivity.DEFAULT_ZOOM);
            MapActivity.Companion.setGotHereFrom(BattleListActivity.class);
