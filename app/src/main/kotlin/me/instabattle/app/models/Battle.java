...
public class Battle {
    ...
    public Battle(Integer creatorId, String name, String description,
        ...
        this.creatorId = State.INSTANCE.getCurrentUser().getId();
        this.userId = creatorId; //FIXME
        this.entriesCount = 1;
    ...
    public void getEntriesAndDo(Callback<List<Entry>> callback) {
        EntryManager.INSTANCE.getByBattleAndDo(id, callback);
    }
    ...
    public void getWinnerAndDo(Callback<List<Entry>> callback) {
        EntryManager.INSTANCE.getTopByBattleAndDo(id, 1, callback);
    }

    public void getVoteAndDo(Callback<List<Entry>> callback) {
        EntryManager.INSTANCE.getVoteAndDo(id, callback);
    }

    public void createEntryAndDo(Callback<Entry> callback) {
        EntryManager.INSTANCE.createAndDo(id, State.INSTANCE.getCurrentUser().getId(), callback);
    }
